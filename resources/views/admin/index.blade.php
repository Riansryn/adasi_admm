                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form id="userForm_{{ $user->id }}" action="{{ route('users.destroy', $user->id) }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
    ...
    function deleteuser(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire({
                    title: "Berhasil!",
                    text: "Nomor user Berhasil dihapus.",
                    icon: "success",
