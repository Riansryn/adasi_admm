                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-warning" href="{{ route('customers.show', $customer->id) }}">
                                            <i class="bi bi-eye-fill"></i>
                                        </a>
                                        <button type="button" class="btn btn-danger" onclick="deletecustomer({{$customer->id}})">
                                            <i class="bi bi-trash-fill"></i>
                                        </button>
                                        <form id="customerForm_{{ $customer->id }}" action="{{ route('customers.destroy', $customer->id) }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
