                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="no_wo" name="no_wo"
                                                ...
                                                value="{{ $handling->no_wo }}" required disabled>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <select name="category" class="form-control" id="category"
                                                ...
                                                <option value="Retak"
                                                    {{ $handling->category == 'Retak' ? 'selected' : '' }}>
                                                    Retak</option>
                                                <option value="Pecah"
                                                    {{ $handling->category == 'Pecah' ? 'selected' : '' }}>
                                                    Pecah</option>
                                                <option value="Etc"
                                                    {{ $handling->category == 'Etc' ? 'selected' : '' }}>
                                                    Etc
                                                </option>
                                        ...
                                        <div class="col-lg-6">
                                            <select name="process_type" class="form-control" id="process_type"
                                                ...
                                                <option value="HeatTreatment"
                                                    {{ $handling->process_type == 'HeatTreatment' ? 'selected' : '' }}>
                                                    Heat
                                                    treatment</option>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-check mr-2">
                                                <input type="checkbox" class="form-check-input" id="type_1"
                                                    ...
                                                    @if ($handling->type_1 == 'Klaim') checked @endif>
